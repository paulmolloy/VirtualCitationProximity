...
# 200_embedding_siames_2x_net preprocceses the data-set into word embeddings and trains the siamese
# 1DCOnvent LSTM model with no dropout on the training data.
...
CPI_DATASET_DIR = '/home/pablo/FYP/1000_with_titles_siamese_2x_no_dropout_200_tokenized_results/'
