...
# 200_embedding_siames_net preprocceses the data-set into word embeddings and trains the siamese
...
CPI_DATASET_DIR = '/home/pablo/FYP/1000_with_titles_siamese_200_tokenized_results/'
...
history = model.fit([x_train[a_columns], x_train[b_columns]], y_train, validation_split=0.1, epochs = 5)
...
model_json = model.to_json()
with open(os.path.join(directory, 'model_' + 'siamese' + CPI_DATASET + '.json'), 'w') as json_model_file:
